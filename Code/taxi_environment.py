...
# This file contains the code for inner working of the taxi environment.
...
class environment:
    def __init__(self):
        ...
        # Defining the number of pick up and drop off locations
        self.goals = 5
    ...
    def pick(self):
        ...
        if not self.passenger and self.taxi_pos == self.pickup:
